...
ActiveRecord::Schema.define(version: 20151110113934) do
  ...
  add_index "activity_groups", ["slug"], name: "index_activity_groups_on_slug", unique: true, using: :btree
